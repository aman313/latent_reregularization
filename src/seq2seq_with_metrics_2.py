...
class SimpleSeq2SeqWithMetrics(Model):
    ...
    def __init__(self,
        ...
        super(SimpleSeq2SeqWithMetrics, self).__init__(vocab)
        ...
        self.__sequence_accuracy = SequenceAccuracy()
    ...
    def get_metrics(self, reset: bool = False) -> Dict[str, float]:
        return {
                'sequence_accuracy': self.__sequence_accuracy.get_metric(reset),
                }
